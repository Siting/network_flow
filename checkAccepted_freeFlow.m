...
travelTimeCollection_stages_1 = [];
travelTimeCollection_stages_2 = [];
for j = 1 : length(studyStages)
    ...
    travelTimeCollection_stages_1 = [travelTimeCollection_stages_1 travelTimeCollection_1];
    travelTimeCollection_stages_2 = [travelTimeCollection_stages_2 travelTimeCollection_2];
end

figure
subplot(2,1,1)
boxplot(travelTimeCollection_stages_1, 'labels', studyStages);
title('sensor 400739');
xlabel('stage');
ylabel('travel time');

subplot(2,1,2)
boxplot(travelTimeCollection_stages_2, 'labels', studyStages);
title('sensor 400363');
xlabel('stage');
ylabel('travel time');
